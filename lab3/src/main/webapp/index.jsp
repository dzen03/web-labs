...
<head>
    ...
    <script>
        ...
        function r_change(r)
        {
            document.getElementById('draw').setAttribute("style", "scale: " + 20 * r + "%; top: 0; position: absolute");
        }
    </script>
...
<%--            <img src="graph.svg" id="graph">--%>
            <img height="100%" width="100%" src="drawing.svg" style="display: none; top: 0; position: absolute" id="draw"/>
            <img height="100%" width="100%" src="graph.svg" style="position: absolute"/>
...
<%--                <image height="100%" width="100%" href="drawing.svg" transform="translate(0, -50%)" id="draw"></image>--%>
<%--                <image height="100%" width="100%" href="graph.svg"></image>--%>
        ...
        <td class="midsplit">
            <form action="index" method="post" id="input_form">
                ...
                <input type="text" hidden name="y_text" id="y_text" oninput="validate()">

                <p>Select R:</p>
                <% for(int i = 1; i <= 5; ++i) {%>
                    <input type="radio" name="r" id="r_<%=i%>" value="<%=i%>" required onclick="r_change(<%=i%>)">
